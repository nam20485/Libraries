...
namespace Libraries.WindowsHookLib
{
    ...
    public delegate IntPtr WindowHookProc(int code, IntPtr wParam, IntPtr lParam);

    internal class Win32HookAPI
    {
    ...
    #region WH_KEYBOARD_LL definitions
    ...
    public struct KeyEventInfo : IEquatable<KeyEventInfo>
    {
        public VirtualKey VkCode { get; private set; }        
        public ScanCode ScanCode { get; private set; }
        public KeyEventFlags Flags { get; private set; }
        public uint Time { get; private set; }
        public UIntPtr DwExtraInfo { get; private set; }
        ...
        {
            return this.Equals((KeyEventInfo) obj);
        }

        public bool Equals(KeyEventInfo other)
        {
            ...
            return (VkCode == other.VkCode &&
                    ...
                    Flags == other.Flags &&
                    DwExtraInfo == other.DwExtraInfo);
        }

        public override int GetHashCode()
        {
            return Convert.ToInt32(((uint) VkCode * 0x00010000) + ((uint) ScanCode * 0x0001000) + ((uint) Flags * 0x000100) + DwExtraInfo.ToUInt32());
        }
       
        public static bool operator ==(KeyEventInfo lhs, KeyEventInfo rhs)
        {
            // Check for null. 
        ...
        public static bool operator ==(KeyEventInfo keyEventInfo, KeyPress keyPress)
        {
            // Check for null. 
            if (Object.ReferenceEquals(keyEventInfo, null))
            {
                if (Object.ReferenceEquals(keyEventInfo, null))
                {
                    // null == null = true. 
            ...
            // Equals handles the case of null on right side. 
            return keyEventInfo.Equals(keyPress);
        }

        public static bool operator !=(KeyEventInfo keyEventInfo, KeyPress keyPress)
        {
            return !(keyEventInfo == keyPress);
        }      
    ...
    #endregion // WH_KEYBOARD_LL definitions
}
