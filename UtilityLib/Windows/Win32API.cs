...
namespace Libraries.UtilityLib.Windows
{
    public static class Win32API
    {
        ...
        public enum MenuItemInfoType : uint
        {
        ...
        public enum MenuItemInfoState : uint
        {
        ...
        public struct MenuItemInfo
        {
            ...
            public MenuItemInfoMask fMask;      //See MenuItemInfo_fMask
            public MenuItemInfoType fType;      //See MenuItemInfo_fType
            public MenuItemInfoState fState;    //See MenuItemInfo_fState
        ...
        public static extern bool AppendMenu(IntPtr hMenu, MenuItemInfoType uFlags, uint uIDNewItem, string lpNewItem);
        ...
        public static IntPtr SetWindowLongPtr(IntPtr hWnd, GetWindowLongs nIndex, int dwNewLong)
        {
            if (IntPtr.Size == 8)
            {
        ...
        private static extern int SetWindowLong32(IntPtr hWnd, GetWindowLongs nIndex, int dwNewLong);

        [DllImport("user32.dll", EntryPoint = "SetWindowLongPtr")]
        private static extern IntPtr SetWindowLongPtr64(IntPtr hWnd, GetWindowLongs nIndex, IntPtr dwNewLong);       

        // This static method is required because Win32 does not support GetWindowLongPtr directly
        public static IntPtr GetWindowLongPtr(IntPtr hWnd, GetWindowLongs nIndex)
        {
            if (IntPtr.Size == 8)
            {
        ...
        private static extern int GetWindowLong32(IntPtr hWnd, GetWindowLongs nIndex);

        [DllImport("user32.dll", EntryPoint = "GetWindowLongPtr")]
        private static extern IntPtr GetWindowLongPtr64(IntPtr hWnd, GetWindowLongs nIndex);
        ...
        public enum GetWindowLongs : int
        {
            GWL_EXSTYLE = -20,
            GWLP_HINSTANCE = -6,
            GWLP_HWNDPARENT = -8,
        ...
        public static extern Error RegNotifyChangeKeyValue(IntPtr        hKey,
                                                            bool          watchSubtree,
        ...
        [Flags]
        public enum RegNotifyChangeFilter : uint
        {
           /// <summary>
        ...
        public static extern Error RegOpenKeyEx(IntPtr hKey, string subKey, RegOption options, RegSAM samDesired,
                                               out IntPtr phkResult);

         [DllImport("advapi32.dll", SetLastError = true)]
        public static extern Error RegCloseKey(IntPtr hKey);
...
//        }       
        ...
        public static extern void keybd_event(uint vkCode, uint scanCode, KeyEventFlags dwFlags, UIntPtr dwExtraInfo);
