...
namespace Libraries.UtilityLib.Windows
{
    public class Win32API
    {
        ...
        protected static extern int GetWindowLong32(IntPtr hWnd, GetWindowLongs nIndex);

        [DllImport("user32.dll", EntryPoint = "GetWindowLongPtr")]
        protected static extern IntPtr GetWindowLongPtr64(IntPtr hWnd, GetWindowLongs nIndex);
